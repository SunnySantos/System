...
<form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-4">
        <label class="label block w-fit" for="old_password">Old Password</label>
        <div class="relative">
            <input type="password" id="old_password" class="input w-full" name="old_password" placeholder="Old Password">
            <label class="swap absolute top-[10px] right-[12px] z-10">
                <input type="checkbox" id="show_hide_old_password" />
