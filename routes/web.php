...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/logout', [LoginController::class, 'logout'])->name('logout')->withoutMiddleware(CheckRoleAccess::class);
    ...
    Route::post('/confirm-password', [ConfirmPasswordController::class, 'confirm'])->middleware(['throttle:6,1'])->withoutMiddleware(CheckRoleAccess::class);
